...
def get_arguments():
    ...
    parser.add_argument(
        '--speaker_text',
        type=str,
        default='../wavenet_data_v2/lab_frame_digit/hs_zh_arctic_hmb_10325.lab',#'../wavenet_data/lab_frame_digit/hs_zh_arctic_bjs_00553.lab',
...
def main():
    ...
    ###net._create_sparse_tensor(sess=sess)
