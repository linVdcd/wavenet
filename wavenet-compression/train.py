...
BATCH_SIZE = 1
DATA_DIRECTORY = '../wavenet_data_v2/train'
LOGDIR_ROOT = './logdir'
...
def get_arguments():
    ...
    parser.add_argument('--vctk', dest='vctk', action='store_true', 
                        default=True, help='Specify using VCTK datset')
    parser.add_argument('--tts', dest='tts', action='store_true',
                        default=True, help='Specify using VCTK datset')
...
def save(saver, sess, logdir, step):
    ...
    tf.train.write_graph(sess.graph.as_graph_def(), 'logdir/train', 'wavenet.pb', False)
    print(' Done.')
...
def main():
    ...
    with tf.name_scope('create_inputs'):
        ...
        reader = AudioReader(
            ...
            vctk=args.vctk,tts=args.tts,ttsfeature_size=wavenet_params['local_channels'])
        ...
        if args.vctk:
            ...
            global_cond = None
            local_cond = reader.tts_conditions_dequeue(args.batch_size)
        else:
            global_cond = None
            local_cond = None
    ...
    try:
        ...
        print("Something went wrong while restoring checkpoint. "
              ...
              "the previous model.")
        raise
    #thread_prune(sess, trainable, threshold=prune_threshold, numthread=24)
    ...
    try:
        ...
        for step in range(saved_global_step + 1, args.num_steps):
            ...
            if args.store_metadata and step % 50 == 0:
                ...
                writer.add_summary(summary, step)
            compression_num=net.thread_prune(sess, threshold=prune_threshold)
            duration = time.time() - start_time
            print('step {:d} - loss = {:.3f} - compression num = {:.1f}, ({:.3f} sec/step)'
                  .format(step, loss_value,compression_num, duration))
